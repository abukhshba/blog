    ...
    <div class="container mx-auto py-6 mt-6 ">
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="flex justify-between items-center mb-16">
                <h2 class="text-2xl font-semibold">Popular Blogs</h2>
                <a href="{{ route('blogs.index') }}" class="bg-yellow-500 hover:bg-yellow-400 text-white px-4 py-2 rounded-lg">See All</a>
            </div>
